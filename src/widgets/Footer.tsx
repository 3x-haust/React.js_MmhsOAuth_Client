      ...
      <FooterContainer>
        <FooterContent>
          <FooterSection>
            ...
            <FooterDescription>
              미림마이스터고 학생 및 교사들을 위한 표준 인증 서비스입니다. 안전하고 편리한 사용자
              인증 시스템으로 여러분의 서비스를 더욱 발전시켜 보세요.
            </FooterDescription>
          </FooterSection>
          ...
          <FooterSection>
            ...
            <FooterLinks>
              ...
              <FooterLink>
                <a
                  href='https://github.com/e-mirim/oauth-full-stack'
                  target='_blank'
          ...
          <FooterSection>
            ...
            <FooterLinks>
              ...
              <FooterLink>
                <a href='https://e-mirim.hs.kr' target='_blank' rel='noopener noreferrer'>
                  미림마이스터고
                </a>
              </FooterLink>
            </FooterLinks>
        ...
        <FooterBottom>
          ...
          <SocialLinks>
            <SocialIcon
              href='https://github.com/3x-haust/React.js_MmhsOAuth_Client'
              target='_blank'
              rel='noopener noreferrer'
              aria-label='GitHub'
            >
